...
class Curl
{
    ...
    private $_config = array(
        ...
        CURLOPT_USERAGENT => 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.124 Safari/537.36'
    );
    ...
    public function buildUrl($url, $data = array())
    {
        ...
        $link_ready = $parsed['scheme'].'://'.$parsed['host'].$parsed['port'].$parsed['path'].$parsed['query'].$parsed['fragment'];
